    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="rounded-lg border border-border bg-bg-card p-6 card-glass">
          <h2 className="mb-2 text-lg font-semibold text-text-primary">Create your account</h2>
          <p className="mb-4 text-sm text-text-muted">Sign up with email and password.</p>
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="flex items-center justify-between">
              ...
              <a className="text-sm text-text-muted" href="/login">Already have an account?</a>
            </div>
          </form>
        </div>
      </div>
